      ...
      <Stack sx={{ height: "100%" }}>
        ...
        >
          <Stack direction={"row"} alignItems={"center"} spacing={2}>
            <Avatar alt={"Sagar"} src={myImg} sx={{ height: 64, width: 64 }} />
            <Stack spacing={0.5}>
          ...
          <Stack direction={"row"}
            ...
            <Stack spacing={0.5}>
              <Typography variant="subtitle2">Coding Hero's</Typography>
              <Typography variant="caption">Paul, Peter, Rabbit, You</Typography>
            </Stack>
          </Stack>
